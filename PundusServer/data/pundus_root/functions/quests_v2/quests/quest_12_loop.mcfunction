...
#questingtime
execute as @a[scores={PQ_QuestComp=0,PQ_Quest_Inc=1}] run title @s actionbar [{"translate":"pundus.server.quests.slay","color":"green"},{"score":{"name":"@s","objective":"PQ_Quest"}},{"text":"/10 "},{"translate":"entity.minecraft.phantom"}]
