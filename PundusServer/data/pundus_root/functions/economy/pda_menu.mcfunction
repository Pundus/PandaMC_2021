...
tellraw @s [{"translate":"pundus.pda.title"}]
...
tellraw @s[scores={Pundus_DmdCount=1..}] [{"color":"green","translate":"pundus.pda.deposit.diamond","hoverEvent":{"action":"show_text","contents":[{"translate":"pundus.pda.deposit.diamond.info"}]},"clickEvent":{"action":"run_command","value":"/trigger Pundus_MenuVar set 104"}}]
tellraw @s[scores={Pundus_Diamonds=1..}] [{"color":"green","translate":"pundus.pda.withdraw.diamond","hoverEvent":{"action":"show_text","contents":[{"translate":"pundus.pda.withdraw.diamond.info"}]},"clickEvent":{"action":"run_command","value":"/trigger Pundus_MenuVar set 103"}}]
