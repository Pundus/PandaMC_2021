...
tellraw @s[scores={Pundus_Diamonds=10..99}] [{"color":"green","translate":"pundus.pda.withdraw.diamond","hoverEvent":{"action":"show_text","contents":[{"translate":"pundus.pda.withdraw.diamond.info"}]},"clickEvent":{"action":"run_command","value":"/trigger Pundus_MenuVar set 103"}},{"color":"green","translate":"pundus.pda.withdraw.diamond.x10","hoverEvent":{"action":"show_text","contents":[{"translate":"pundus.pda.withdraw.diamond.info"}]},"clickEvent":{"action":"run_command","value":"/trigger Pundus_MenuVar set 1031"}},{"color":"green","translate":"pundus.pda.withdraw.diamond.all","hoverEvent":{"action":"show_text","contents":[{"translate":"pundus.pda.withdraw.diamond.info"}]},"clickEvent":{"action":"run_command","value":"/trigger Pundus_MenuVar set 1032"}}]

tellraw @s[scores={Pundus_Diamonds=100..}] [{"color":"green","translate":"pundus.pda.withdraw.diamond","hoverEvent":{"action":"show_text","contents":[{"translate":"pundus.pda.withdraw.diamond.info"}]},"clickEvent":{"action":"run_command","value":"/trigger Pundus_MenuVar set 103"}},{"color":"green","translate":"pundus.pda.withdraw.diamond.x10","hoverEvent":{"action":"show_text","contents":[{"translate":"pundus.pda.withdraw.diamond.info"}]},"clickEvent":{"action":"run_command","value":"/trigger Pundus_MenuVar set 1031"}},{"color":"green","translate":"pundus.pda.withdraw.diamond.x100","hoverEvent":{"action":"show_text","contents":[{"translate":"pundus.pda.withdraw.diamond.info"}]},"clickEvent":{"action":"run_command","value":"/trigger Pundus_MenuVar set 1033"}},{"color":"green","translate":"pundus.pda.withdraw.diamond.all","hoverEvent":{"action":"show_text","contents":[{"translate":"pundus.pda.withdraw.diamond.info"}]},"clickEvent":{"action":"run_command","value":"/trigger Pundus_MenuVar set 1032"}}]
