...
execute if score %LBVal Pundus_RNG matches 0..3 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.ring_btn.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 4..9 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.brunos_pickaxe.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 10..13 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.luminaire.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 14..17 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.scepter_rising_sun.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 18..23 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.first_new_breath.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 24..32 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.spell_life_tempus.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 33..34 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.crimson_dagger.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 35..43 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.spell_angels_fear.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 44..52 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.elite_assault_golems.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 53..58 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.windforce.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 59..62 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.skybound.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 63..68 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.counter_thrust_boots.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 69..72 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.spectral_quiver.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 73..78 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.magnetized_leggings.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 79..88 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.lunarite_dust.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 89..90 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.vorpal_dagger.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
...
execute if score %LBVal Pundus_RNG matches 91..99 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.ethereal_apple.name"},{"translate":"pundus.item.gashapon.btn.name"}]}
