...
execute if score %LBVal Pundus_RNG matches 0..2 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.crimson_battleaxe.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 3..8 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.reaping_scythe.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 9..16 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.fertilizing_feet.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 17..24 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.scepter_mindless_translocation.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 25..27 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.scepter_spirit_shift.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 28..33 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.mini_crossbow.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 34..39 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.firebrand.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 40..47 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.spell_dead_men_walking.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 48..55 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.chestplate_satiation.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 56..61 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.leggings_restoration.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 62..70 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.golem_reinforcements.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 71..79 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.golem_cannon_fodder.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 80..89 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.zombosoda.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 90..95 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.history_of_fish.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
...
execute if score %LBVal Pundus_RNG matches 96..99 as @s run tellraw @a[team=Admin,tag=AdminAlerts] {"translate":"pundus.admin.alerts.unbox","color":"gray","italic":true,"with":[{"selector":"@s"},{"translate":"pundus.item.basic_quiver.name"},{"translate":"pundus.item.gashapon.undead_rising.name"}]}
