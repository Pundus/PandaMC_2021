...
scoreboard players set @a[scores={POOC_1=1..}] POOC_Track 40
...
scoreboard players set @a[scores={POOC_6=1..}] POOC_Track 40
scoreboard players set @a[scores={POOC_7=1..}] POOC_Track 40
