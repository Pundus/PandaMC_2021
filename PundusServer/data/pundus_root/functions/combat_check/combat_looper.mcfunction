...
execute as @a[scores={POOC_Track=1..}] at @s if entity @e[type=#pundus_root:hostile_all_mobs,distance=..24,team=!Friendly] run scoreboard players set @s POOC_Track 60
execute as @a at @s if entity @e[type=#pundus_root:hostile_all_mobs,distance=..5,team=!Friendly] run scoreboard players set @s POOC_Track 30
#execute as @a at @s if entity @e[type=#pundus_root:hostile_all_mobs,distance=..24,team=!Friendly] run scoreboard players set @s POOC_Track 30
...
schedule function pundus_root:combat_check/combat_looper 6t