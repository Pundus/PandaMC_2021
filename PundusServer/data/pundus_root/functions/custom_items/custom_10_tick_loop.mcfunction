...
execute as @a[predicate=pundus_root:custom_items/10_tick/10_tick_mainhand] at @s run function pundus_root:custom_items/10_tick/10_tick_mainhand_disambig
execute as @a[predicate=pundus_root:custom_items/10_tick/10_tick_offhand] at @s run function pundus_root:custom_items/10_tick/10_tick_offhand_disambig
