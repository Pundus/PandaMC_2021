...
execute as @s at @s if score @s IMF_Damage matches 326.. run item entity @s weapon.offhand replace air


tag @e[type=arrow,limit=1,sort=nearest] add Arrow_DoI


advancement revoke @s only pundus_root:custom_items/gun/gun_fired_offhand