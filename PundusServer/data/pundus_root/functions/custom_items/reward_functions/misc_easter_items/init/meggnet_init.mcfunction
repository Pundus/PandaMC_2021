...
execute as @s at @s if entity @e[type=item,tag=Redropped_Egg,distance=..16] run function pundus_root:custom_items/reward_functions/misc_easter_items/meggnet
