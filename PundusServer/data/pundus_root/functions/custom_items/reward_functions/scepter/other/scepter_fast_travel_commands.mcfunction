...
execute in minecraft:overworld as @s if score @s Pundus_MenuVar matches 1031003 run tp @s -247 72.00 114
...
execute in minecraft:overworld as @s if score @s Pundus_MenuVar matches 1031004 run tp @s -346 64 -273
