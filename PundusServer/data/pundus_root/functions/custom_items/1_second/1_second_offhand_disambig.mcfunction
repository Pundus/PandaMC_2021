...
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{pundus_id:"reaping_scythe"}}]}] unless score @s Pundus_ReapSCD matches 1.. at @s unless block ~ 319 ~ minecraft:structure_void run function pundus_root:custom_items/1_second/reaping_scythe_activate
...
execute as @s[nbt={Inventory:[{Slot:-106b,tag:{pundus_id:"scepter_spirit_shift"}}]}] unless score @s Pundus_ScptSSCD matches 1.. at @s unless block ~ 319 ~ minecraft:structure_void run function pundus_root:custom_items/1_second/scepter_spirit_shift
