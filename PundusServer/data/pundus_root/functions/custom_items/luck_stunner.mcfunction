...
execute if score @s Pundus_MobTrk1 matches 1 run data modify entity @s Silent set value 0b
execute if score @s Pundus_MobTrk1 matches 1 run data modify entity @s NoAI set value 0b
execute if score @s Pundus_MobTrk1 matches 2.. run data modify entity @s Silent set value 1b
