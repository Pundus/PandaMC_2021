...
tellraw @s[tag=Pundus_PKI] [{"color":"yellow","translate":"pundus.special.pki.return"}]
tellraw @s[tag=!Pundus_PKI] [{"color":"yellow","translate":"pundus.special.pki.return_egg"}]
