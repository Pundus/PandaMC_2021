...
tellraw @s [{"color":"aqua","translate":"pundus.npc.generic.dialog.quest_finish","clickEvent":{"action":"run_command","value":"/trigger Pundus_NPCMenu set 8880002"},"with":[{"translate":"pundus.custom_quest.lance.fight.name","color":"aqua","underlined":false}]}]
