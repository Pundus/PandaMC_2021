...
tellraw @s[tag=hm_decor_wasabee] [{"color":"green","translate":"pundus.npc.cm.claim.generic","with":[{"translate":"pundus.item.decor.wasabee.name"}],"clickEvent":{"action":"run_command","value":"/trigger Pundus_HMItem set 13"}}]
