...
tellraw @s [{"translate":"pundus.npc.generic.dialog.prefix","with":[{"selector":"@e[type=villager,tag=Pundus_IntNPC,sort=nearest,limit=1]"}]},{"translate":"pundus.npc.eggologist.dialog.quest_collect","color":"white","with":[{"score":{"name":"%Goal","objective":"PM_Wradin_1"}}]}]
