...
execute as @s at @s if score @s PM_Wradin_1_CD matches 1.. run tellraw @s [{"color":"dark_aqua","translate":"pundus.npc.generic.dialog.cooldown","with":[{"score":{"name":"*","objective":"PM_Wradin_1_CD"}}]}]
...
execute as @s at @s if score @s PM_Wradin_2_CD matches 1.. run tellraw @s [{"color":"dark_aqua","translate":"pundus.npc.generic.dialog.cooldown","with":[{"score":{"name":"*","objective":"PM_Wradin_2_CD"}}]}]
...
execute as @s at @s if score @s PM_Wradin_3_CD matches 1.. run tellraw @s [{"color":"dark_aqua","translate":"pundus.npc.generic.dialog.cooldown","with":[{"score":{"name":"*","objective":"PM_Wradin_3_CD"}}]}]
