...
attribute @s minecraft:zombie.spawn_reinforcements base set 0.3
...
attribute @s minecraft:generic.movement_speed base set .2

tag @s add Pundus_UR_Balanced_Easy
tag @s add Pundus_UR_Balanced